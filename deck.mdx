...
<Notes>
  ...
  <p>- Paginar todo mundo em relação ao Istio</p>
...
<div style={{fontSize: 35}}>
  <CodeSurfer
    ...
    steps={[
      ...
      { lines: [2], notes: "Build" },
      { lines: [3], notes: "Destination" },
      { lines: [4], notes: "Labels" },
      { lines: [5], notes: "Request Headers" },
...
<https://github.com/vsantos/gophercon> [presentation]
